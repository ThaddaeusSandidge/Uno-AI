...
void main()
{
	...
	thePlayers.push_back(new Player(0, 8)); // the 1 passed in here indicates the ai from the player constructor.
	thePlayers.push_back(new Player(1, 8)); // the 1 passed in here indicates the ai from the player constructor.
	thePlayers.push_back(new Player(2, 8)); // the 1 passed in here indicates the ai from the player constructor.
	thePlayers.push_back(new Player(3, 3)); // the 1 passed in here indicates the ai from the player constructor.
	thePlayers.push_back(new Player(4, 3)); // the 1 passed in here indicates the ai from the player constructor.
	...
	/*
	for (int i = 0; i < 100000; i++) //250,000 against BMOOD
	{
		playGame(players, thePlayers, scores);
